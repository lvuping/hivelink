const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "HiveLink를 사용해 주셔서 감사합니다. 문의사항이 있으시면 info@dexterbee.com으로 연락 주시기 바랍니다.",
    part2:
      "HiveLink는 RAG(Retrieval Augmented Generation) 기술을 활용한 AI 챗봇 솔루션입니다. 데이터를 안전하고 비공개로 유지하면서 정확하고 맞춤화된 응답을 제공합니다.",
    part3: "워크스페이스에 문서를 업로드하여 나만의 AI 챗봇을 만들어보세요.",
  ...
  api: {
    title: "API 키",
    description:
      "API 키는 소유자가 프로그래밍 방식으로 이 HiveLink 인스턴스에 액세스하고 관리할 수 있도록 합니다.",
    link: "API 문서 읽기",
    generate: "새 API 키 생성",
    table: {
      key: "API 키",
  ...
  llm: {
    title: "LLM 기본 설정",
    description:
      "이것은 채팅과 임베딩을 하기 위한 선호하는 LLM 제공자의 인증입니다. 이 키가 현재 활성 상태이고 정확해야 HiveLink이 제대로 작동합니다.",
    provider: "LLM 제공자",
  },
  ...
  transcription: {
    ...
    provider: "텍스트 변환 제공자",
    "warn-start":
      "RAM 또는 CPU 성능이 제한된 머신에서 로컬 위스퍼 모델을 사용하면 미디어 파일을 처리할 때 HiveLink이 중단될 수 있습니다.",
  ...
  embedding: {
    ...
    "desc-end":
      "임베딩은 텍스트를 벡터로 변환하는 과정입니다. 파일과 프롬프트를 HiveLink이 처리할 수 있는 형식으로 변환하려면 이러한 인증이 필요합니다.",
    provider: {
      title: "임베딩 제공자",
      description:
        "HiveLink의 기본 임베딩 엔진을 사용할 때는 설정이 필요하지 않습니다.",
    },
  },
  ...
  vector: {
    title: "벡터 데이터베이스",
    description:
      "이것은 HiveLink 인스턴스가 벡터 데이터베이스 사용을 위한 인증 설정입니다. 이 키가 활성 상태이고 정확해야 합니다.",
    provider: {
      title: "벡터 데이터베이스 제공자",
  ...
  multi: {
    ...
    password: {
      title: "비밀번호 보호",
      description:
        "HiveLink 인스턴스를 비밀번호로 보호하십시오. 이 비밀번호를 잊어버리면 복구 방법이 없으므로 반드시 저장하세요.",
    },
    instance: {
      title: "인스턴스 비밀번호 보호",
      description:
  ...
  privacy: {
    title: "개인정보와 데이터 처리",
    description:
      "연결된 타사 제공자와 HiveLink이 데이터를 처리하는 방식을 구성합니다.",
    llm: "LLM 선택",
    embedding: "임베딩 기본 설정",
    vector: "벡터 데이터베이스",
