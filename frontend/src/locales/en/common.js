const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Thank you for using HiveLink. If you have any questions, please feel free to contact us at info@dexterbee.com.",
    part2:
      "HiveLink is an AI chatbot solution powered by RAG (Retrieval Augmented Generation) technology. It provides accurate and customized responses while keeping your data secure and private.",
    part3:
      "Start by uploading your documents to a Workspace to create your own AI chatbot.",
  ...
  appearance: {
    ...
    message: {
      ...
      user: "user",
      message: "message",
      assistant: "HiveLink Chat Assistant",
  ...
  api: {
    title: "API Keys",
    description:
      "API keys allow the holder to programmatically access and manage this HiveLink instance.",
  ...
  llm: {
    ...
    description:
      "These are the credentials and settings for your preferred LLM chat & embedding provider. Its important these keys are current and correct or else HiveLink will not function properly.",
  ...
  transcription: {
    ...
    "warn-start":
      "Using the local whisper model on machines with limited RAM or CPU can stall HiveLink when processing media files.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding is the process of turning text into vectors. These credentials are required to turn your files and prompts into a format which HiveLink can use to process.",
    provider: {
      title: "Embedding Provider",
      description:
        "There is no set up required when using HiveLink's native embedding engine.",
    },
  },
  ...
  vector: {
    ...
    description:
      "These are the credentials and settings for how your HiveLink instance will function. It's important these keys are current and correct.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Protect your HiveLink instance with a password. If you forget this there is no recovery method so ensure you save this password.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "This is your configuration for how connected third party providers and HiveLink handle your data.",
    llm: "LLM Selection",
